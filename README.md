...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-grpreg-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-grpreg-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-grpreg-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-grpreg-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-grpreg-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-grpreg-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-grpreg/badges/version.svg)](https://anaconda.org/conda-forge/r-grpreg)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-grpreg/badges/downloads.svg)](https://anaconda.org/conda-forge/r-grpreg)
